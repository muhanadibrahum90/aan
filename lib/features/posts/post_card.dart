...
import 'package:an/features/posts/post_detail_page.dart';
import 'package:share_plus/share_plus.dart';
import 'package:an/features/profile/profile_page.dart';
import 'package:an/services/notification_service.dart';
import 'package:an/services/cache_manager.dart';
import 'package:an/features/posts/edit_post_page.dart';
import '../chat/share_to_chat_page.dart';
import 'package:an/services/snack_bar_service.dart';
...
class _PostCardState extends State<PostCard> {
  ...
  Future<void> _deleteImageFromR2(String imageUrl) async {
    ...
    try {
      ...
      await http.post(
        Uri.parse('https://an-upload.an52907394.workers.dev/delete-post-image'),
        headers: {
